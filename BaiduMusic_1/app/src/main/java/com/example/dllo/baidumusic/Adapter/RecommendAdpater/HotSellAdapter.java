...
public class HotSellAdapter extends RecyclerView.Adapter<HotSellAdapter.DoubleItemViewHolder>{

    private RecommendBean.ResultBeanXXXXXXXXXXXXX.Mix22Bean data;
    private Context context;

    public void setData(RecommendBean.ResultBeanXXXXXXXXXXXXX.Mix22Bean data) {
        this.data = data;
