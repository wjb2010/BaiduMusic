...
public class VideoRightAdapter extends RecyclerView.Adapter<VideoRightAdapter.MusicListViewHolder> {

    private VideoRightBean data;
    private Context context;


    public VideoRightAdapter(Context context) {
        this.context = context;
    }

    public void setData(VideoRightBean data) {
