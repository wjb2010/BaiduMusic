...
public class MySideViewFromRight extends ViewGroup {
    ...
    public MySideViewFromRight(Context context, AttributeSet attrs) {
        ...
        TypedArray typedArray=context.obtainStyledAttributes(attrs, R.styleable.MySideViewFromRight);
//

        isText=typedArray.getString(R.styleable.MySideViewFromRight_getText);
//        int resourceId = 0;
