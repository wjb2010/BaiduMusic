...
public class OriMusicAdapter extends RecyclerView.Adapter<OriMusicAdapter.DoubleItemViewHolder>{

    private RecommendBean.ResultBeanXXXXXXXXXXXXX.Mix9Bean data;
    private Context context;

    public void setData(RecommendBean.ResultBeanXXXXXXXXXXXXX.Mix9Bean data) {
        this.data = data;
        notifyDataSetChanged();
    }

    public OriMusicAdapter(Context context) {
