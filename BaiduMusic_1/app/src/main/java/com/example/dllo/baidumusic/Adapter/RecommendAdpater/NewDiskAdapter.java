...
public class NewDiskAdapter extends RecyclerView.Adapter<NewDiskAdapter.DoubleItemViewHolder>{

    private RecommendBean.ResultBeanXXXXXXXXXXXXX.Mix1Bean data;
    private Context context;

    public void setData(RecommendBean.ResultBeanXXXXXXXXXXXXX.Mix1Bean data) {
        this.data = data;
        notifyDataSetChanged();
    }

    public NewDiskAdapter(Context context) {
