...
public class LeBoAdapter extends RecyclerView.Adapter<LeBoAdapter.DoubleItemViewHolder>{

    private RecommendBean.ResultBeanXXXXXXXXXXXXX.RadioBean data;
    private Context context;

    public void setData(RecommendBean.ResultBeanXXXXXXXXXXXXX.RadioBean data) {
        this.data = data;
        notifyDataSetChanged();
    }

    public LeBoAdapter(Context context) {
